      ...
      <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="mb-8 sm:mb-12">
          ...
          <p className="text-sm sm:text-base text-muted-foreground font-light">
            Create and manage class sessions for courses
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
          ...
          <Card className="luxury-card border-0 w-full lg:w-[380px] lg:sticky lg:top-6 order-1 lg:order-2 shrink-0">
            <CardHeader className="pb-4 sm:pb-6">
              <CardTitle className="text-base sm:text-lg font-medium tracking-tight uppercase">Create Class Session</CardTitle>
              <CardDescription className="text-sm font-light">Creates class session for all {weekends.length} weekends automatically</CardDescription>
            </CardHeader>
            <CardContent>
              <CreateSessionForm weekends={weekends} sessionType="CLASS" />
            </CardContent>
          </Card>
        </div>
      </main>
